...
// Creator: Chiru Labs
// Modifier: sampleProject

// LICENSE
// ERC721AUpgradeable.sol modifies Chiru Lab's ERC721AUpgradeable.sol:
// https://github.com/chiru-labs/ERC721A-Upgradeable/blob/103251dd9276b733e010521b5b0da4910e29f911/contracts/ERC721AUpgradeable.sol
//
// ERC721AUpgradeable.sol source code copyright Chiru Labs licensed under the MIT License.
// With modifications by SampleProject DAO.
//
//
// MODIFICATIONS:
...
contract ERC721AUpgradeable is ERC721A__Initializable, IERC721AUpgradeable {
    ...
    /**
     * @dev Mints `quantity` tokens and transfers them to `to`, and emits two log events -
    ...
    function _mint(
        ...
        // @todo Emit an event for the specified quantity of tokenIds. (research if it's needed)
        _afterTokenTransfers(address(0), creator, startTokenId, quantity);
        _afterTokenTransfers(creator, to, startTokenId, quantity);
    }
    ...
    function _mintERC2309(
        ...
        _beforeTokenTransfers(address(0), creator, startTokenId, quantity);
        _beforeTokenTransfers(creator, to, startTokenId, quantity);
